...
cd $BUILD_DIRECTORY
cmake -DCMAKE_BUILD_TYPE=Release -DFISHNET_TEST=OFF -DFISHNET_APPS=ON -DFISHNET_TEST_LIB=OFF -DCMAKE_INSTALL_LIBDIR=lib -DCMAKE_INSTALL_PREFIX=$INSTALL_PREFIX ..
