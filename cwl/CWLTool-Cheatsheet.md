...
| `--tmpdir-prefix` `<Directory>` | Sets directory for temporary files
| `--log-dir` `<Directory>`| Sets directory for log files
| `--js-console` | Allows debugging js code with `console.log()`
