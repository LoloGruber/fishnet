...
inputs:
    ...
    eps:
        ...
        inputBinding:
            prefix: --eps
        doc: "Epsilon parameter for DBSCAN"
    minPts:
        type: int
        inputBinding:
            prefix: --minPts
        doc: "Minimum points parameter for DBSCAN"   
    outputStem:
        type: string
        inputBinding:
            position: 2
...
stdout: DBSCAN_CLUSTERING_$(inputs.components[0])_stdout.log
stderr: DBSCAN_CLUSTERING_$(inputs.components[0])_stderr.log